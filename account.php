  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image\1.jpg" width=100 height=100 alt="Nikita Singh" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Nikita Singh</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 </h4>
		<h4 style="font-family:'typo' ">nikita.js@somaiya.edu</h4>
		<h4 style="font-family:'typo' ">KJ Somaiya College of
    
    Engineering</h4></div></div>
		</p>
      </div>
